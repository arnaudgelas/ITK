...
protected:
  ...
  /** \class NeighborhoodScanningWindowDenseGetValueAndDerivativeThreader
   * \brief Run on the points defined by an ImageRegion.
   * \ingroup ITKHighDimensionalMetrics
   * */
  class NeighborhoodScanningWindowDenseGetValueAndDerivativeThreader
    : public NeighborhoodScanningWindowGetValueAndDerivativeThreader< ThreadedImageRegionPartitioner< VirtualImageDimension > >
  {
  public:
    /** Standard class typedef. */
    typedef NeighborhoodScanningWindowDenseGetValueAndDerivativeThreader                              Self;
    typedef NeighborhoodScanningWindowGetValueAndDerivativeThreader< ThreadedImageRegionPartitioner< VirtualImageDimension > >
                                                                            Superclass;
    typedef SmartPointer< Self >                                            Pointer;
    typedef SmartPointer< const Self >                                      ConstPointer;
    ...
    itkTypeMacro( NeighborhoodScanningWindowImageToImageObjectMetric::NeighborhoodScanningWindowDenseGetValueAndDerivativeThreader,
      NeighborhoodScanningWindowImageToImageObjectMetric::GetValueAndDerivativeThreader );
  ...
  private:
    NeighborhoodScanningWindowDenseGetValueAndDerivativeThreader( const Self & ); // purposely not implemented
